...
#traceplots
plot(samples[,"sigma"], type="l", col="red")
...
layout(matrix(1:4, nrow=2))
#histograms
hist(samples[,"sigma"], col="red", breaks=100, xlab=expression(paste(sigma)), main="", border=NA)
abline(v=exp(wren.hr$ddf$par)[2], col="blue", lwd=2)
hist(samples[,"b"], col="red", xlab="b", breaks=100, main="", border=NA)
abline(v=exp(wren.hr$ddf$par)[1], col="blue", lwd=2)
#traceplots
plot(samples[,"sigma"], type="l", ylim=c(0, 100), col="red")
